...
export function MusicCard({
  ...
  return (
    <div
      className={`w-full max-w-md bg-[#121416]/85 backdrop-blur-xl border border-white/15 rounded-2xl p-3.5 sm:p-4 shadow-[0_16px_50px_rgba(0,0,0,0.8)] text-[#e2e2e5] select-none transition-all duration-300 relative overflow-hidden ${className}`}
    >
      {/* Inner Subtle Glow */}
      ...
      <div className="relative z-10 space-y-3">
        {/* Top Row: Track Thumbnail, Title & Artist */}
        <div className="flex items-center gap-3">
          {/* Spinning Disc Thumbnail (Compact) */}
          <div className="relative w-11 h-11 rounded-full border border-white/15 bg-[#1a1c1e] flex items-center justify-center shrink-0 overflow-hidden shadow-md">
            <div
          ...
          <div className="min-w-0 flex-1">
            <h3 className="font-serif text-sm sm:text-base font-bold text-[#ffd7a9] truncate leading-tight">
              {trackTitle}
            </h3>
            <p className="font-sans text-xs text-[#d6c3b0]/70 truncate mt-0.5">
              {artistName}
            </p>
          </div>

          {/* Radio Pahad Badge */}
          <span className="px-2.5 py-1 bg-[#ffb347]/15 rounded-full border border-[#ffb347]/30 font-mono text-[9px] text-[#ffd7a9] uppercase tracking-wider shrink-0">
            Radio Pahad
          </span>
        </div>
